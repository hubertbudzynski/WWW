            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.timeout(2000);
                        _a = chai_1.expect;
                        return [4 /*yield*/, mocha_webdriver_1.driver.find('input[name="action"]').getText()];
                    case 1:
                        _a.apply(void 0, [_b.sent()]).to.equal('login');
                        return [4 /*yield*/, mocha_webdriver_1.driver.find('input[name="login"]').sendKeys('user1')];
                    case 2:
                        _b.sent();
